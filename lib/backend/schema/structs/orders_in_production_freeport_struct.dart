...
class OrdersInProductionFreeportStruct extends BaseStruct {
  OrdersInProductionFreeportStruct({
    int? orderNumber,
    String? orderStatus,
    int? orderStatusID,
  ...
  static OrdersInProductionFreeportStruct fromMap(Map<String, dynamic> data) =>
      OrdersInProductionFreeportStruct(
  ...
  static OrdersInProductionFreeportStruct? maybeFromMap(dynamic data) => data
          is Map
      ? OrdersInProductionFreeportStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static OrdersInProductionFreeportStruct fromSerializableMap(
  ...
  @override
  String toString() => 'OrdersInProductionFreeportStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is OrdersInProductionFreeportStruct &&
...
OrdersInProductionFreeportStruct createOrdersInProductionFreeportStruct({
  int? orderNumber,
  String? orderStatus,
  int? orderStatusID,
  String? productionDate,
